...
double battery,light_sens_val, threshold, pwm_x, pwm_y;
double gyro_y, gyro_x,phi_m_y, phi_m_x;
...
void balance_and_control(void){
  ...
  state_est_and_control(gyro_y, gyro_x,
                        phi_m_y, phi_m_x, &pwm_y,&pwm_x);
  
  command_Motor(pwm_x,pwm_y); //Sends duty cycle values to servos
}
